    ...
    <div className="px-4 py-6 sm:px-0">
      <div className="border-4 border-dashed border-gray-200 rounded-lg p-4 md:p-6 text-center flex flex-col justify-center items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 w-full max-w-4xl">
          ...
          <Link
            href="/dashboard/logs"
            className="flex flex-col items-center justify-center bg-orange-600 hover:bg-orange-700 text-white font-semibold py-4 px-3 rounded-lg text-center transition duration-150 ease-in-out shadow-md hover:shadow-lg"
          >
            <ClipboardDocumentListIcon className="h-8 w-8 mb-2" />
            <span className="text-sm">Логове</span>
          </Link>
          <Link
            href="/profile"
