      ...
      <div className="bg-white shadow-md rounded-lg p-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full px-5 py-2 border border-transparent bg-indigo-600 text-white font-medium rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 transition-colors"
          >
            Зареди отново
          </button>
        </div>
