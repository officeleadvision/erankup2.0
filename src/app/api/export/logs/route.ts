...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      note:
        scope === "global"
          ? "Като администратор виждате всички действия с устройства, въпроси и експорти за всеки акаунт."
          : "Всички експорти, промени на устройства и промени на въпроси за този акаунт.",
    });
  } catch (error) {
